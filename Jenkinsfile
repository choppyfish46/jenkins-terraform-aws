awsCredentialsId = 'f888888841e627-5f99-4023-b278-8a1d895590d4c'
...
pipeline {
   ...
   parameters {
    ...
    string(name: 'manohad2', defaultValue : '', description: "Jenkins credential that provides the AWS access key and secret.")
